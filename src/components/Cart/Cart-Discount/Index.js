...
//       .then((resp) => {
//         console.log(resp.data, "data of the staff tip");
//         // Assuming the API response contains a property called "delivery_charge"
...
//     <>
//       <Container>
//         <h4 className="mt-3 mb-3">Tip the crew</h4>
//         <Row>
//           <Col xs={12}>
//             <Box sx={{ width: "100%" }}>
//               <Box>
...
//         >
//           <div className="delivery-fee-left">Total Amount</div>
...
//     setValue(isTipEnabled ? value : 3); // If disabling tip, switch to the "Other" tab
//   };
...
//                     label="Pickup"
//                   />
//                   {/* Square radio button for "I don't want to pay tip" */}
//                 </RadioGroup>
//               </FormControl>

//               <br />

//               {/* Render "Staff Tip" section only if tip is not disabled */}
//               {value !== 3 && (
//                 <TabPanel className="cart-tabpanel" value={value} index={3}>
//                   <div className="cart-discoutn1">
//                     <div className="staff-tip">
...
//               )}
//               <div
//                 className="cart-fee-estimated-name mt-2"
